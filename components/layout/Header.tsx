...
export function Header() {
  ...
  // const userEmail = session?.user?.email ?? ""; // reserved for future use
  ...
  return (
    <header className="h-16 bg-surface border-b flex items-center justify-between px-4 sticky top-0 z-10 shadow-sm md:px-6">
