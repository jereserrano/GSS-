  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        sena: {
          50:  'var(--color-sena-50)',
          100: 'var(--color-sena-100)',
          200: 'var(--color-sena-200)',
          300: 'var(--color-sena-300)',
          400: 'var(--color-sena-400)',
          500: 'var(--color-sena-500)',
          600: 'var(--color-sena-600)',
          700: 'var(--color-sena-700)',
          800: 'var(--color-sena-800)',
          900: 'var(--color-sena-900)',
          950: 'var(--color-sena-950)',
        },
        verde: {
